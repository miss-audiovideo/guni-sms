switchSections = [
    {"title": "Who we are?", "description": "We are Guni, a software company based in paramatta, Australia, who strives to provide businesses with tools that would help in better engagement and growth.", "image": "assets/assets-api/img/about/img-1-thumb.png"},
    {"title": "What do we do?", "description": "We aim to improve upon the means of communication for businesses all across the world by leveraging technology.", "image": "assets/assets-api/img/about/img-3-thumb.png"},
    {"title": "How do we do it?", "description": "Our messaging platform helps businesses in engaging with their key stakeholders through an omnichannel approach. With engagement tools such as SMS, MMS, Landing Pages, Email and Vice-Versa and Chatbots, your business could deliver the right message, on the right set of channels, at the right moment.", "image": "assets/assets-api/img/about/img-2-thumb.png"},
];
